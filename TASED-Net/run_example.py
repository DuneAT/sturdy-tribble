...
def main():
    ...
    #path_indata = './example'
    path_indata = 'C:/Users/dunea/Documents/Projet_Julia/Human-Attention/data/processed_data/passive2'
    path_output = './output_passive'
    ...
    print(c)
    print('temps par frame :')
    print((t_fin-t_debut)/c)
